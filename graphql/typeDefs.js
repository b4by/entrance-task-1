...
// Удалил SearchResult. Это можно было бы использовать
// для поиска.
// Также удалил UserRoom т.к. не увидел где он используется.
// Перенес usersIds в EventInput, чтобы можно было и 
// при обновлении проверять на пользователей.